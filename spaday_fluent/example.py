...
<style>
  ...
  .members { box-sizing: border-box; width: min(100%, 28rem); gap: .75rem; padding: .5rem; }
  ...
  .member, .member fluent-text { min-width: 0; }
  .member { display: flex; align-items: center; gap: .75rem; }
  .member fluent-text { overflow-wrap: anywhere; }
