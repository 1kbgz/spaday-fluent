...
const RENAMED = {
  "fluent-dropdown-option": "fluent-option",
  "fluent-text-area": "fluent-textarea",
};
...
const UNPUBLISHED = fs.existsSync("tools/unpublished.json")
  ...
  : {};
// platform and FAST bases contribute nothing an author sets
const PLATFORM = new Set(["HTMLElement", "FASTElement"]);
